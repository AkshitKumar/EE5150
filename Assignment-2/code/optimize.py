...
ES2sq = np.divide((40.0*41.0*81.0 - np.multiply(x,np.multiply(x+1,2*x+1))),6*(40-x)*r*r)
rho1 = np.multiply(lambda1,ES1)
rho2 = np.multiply(lambda2,ES2)
W1 = np.divide(np.multiply(lambda1,ES1sq),2*(1 - rho1))
W2 = np.divide(np.multiply(lambda2,ES2sq),2*(1 - rho2))
